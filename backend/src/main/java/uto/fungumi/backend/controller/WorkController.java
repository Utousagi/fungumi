...
public class WorkController {
    ...
    @GetMapping("/id")
    public BaseResult<Page<Work>> findAllWorkById(@RequestParam(defaultValue = "0", value = "pageNo") Integer pageNo,
    ...
    @GetMapping("/rank")
    public BaseResult<Page<Work>> findAllWorkByRank(@RequestParam(defaultValue = "0", value = "pageNo") Integer pageNo,
                                                    @RequestParam(defaultValue = "10", value = "pageSize") Integer pageSize){
