import { Layout, Link, Image, Slider, Pagination } from "@arco-design/web-react";
...
let data: CommentPageData = {
	...
	comments: [{
		...
		score: 7,
		time: "Now",
		content: "可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏，可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏，可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏,可爱滴捏",
		like: false,
		dislike: false,
		likes: 233
	},],
	...
	return (
		<Layout style={{ width: "95%", height: '400px' }}>
			<Header style={{ width: '105%', alignSelf: 'center', flexDirection: "column", alignItems: "start", height: "100%" }}>
				<Link href={subjectUrl}><h1>{data.title}</h1></Link>
			...
			<Layout style={{}}>
				...
				<Content style={{ width: '120%'}}>
					...
					<Pagination total={data.total} defaultPageSize={5} defaultCurrent={props.page} onChange={(pageNumber: number) => {
						setReviewList(data.comments.slice((pageNumber - 1) * 10, pageNumber * 10));
					}} />
				</Content>
			</Layout>
			<Footer>
