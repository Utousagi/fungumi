...
const data: InfoPageData = {
  ...
  description:
    "职阶降临者（Foreigner），在亚种特异点 Ⅳ 禁忌降临庭园 塞勒姆 异端塞勒姆登场。名为阿比盖尔的同名角色为历史上美国塞勒姆审巫案的关键角色，并被多部影视作品改编。本作的阿比盖尔是魔神柱劳姆以史实为基础创造出的架空人格。",
  likes: [
    {
      userId: "Abigail",
      avatar:
      ...
      <Layout style={{ width: "190px", margin: "5px" }}>
        <Sider style={{ width: "80px", textAlign: "center" }}>
          <Link to={"/subject/" + props.favourite.id}>
            <Image height={80} src={props.favourite.image} />
          </Link>
        </Sider>
        <Content style={{ display: "contents" }}>
          <div style={{ display: "flow", margin: "0px 0px 0px 5px" }}>
            ...
            <Tag>{props.favourite.workType}</Tag>
          </div>
        </Content>
      </Layout>
      <Divider />
